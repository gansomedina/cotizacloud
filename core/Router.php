...
class Router
{
    ...
    public static function register_all(): void
    {
        ...
        self::post('/cotizaciones/:id/enviar-correo', fn($p) => self::app('cotizaciones', 'enviar_correo', $p));
        self::post('/cotizaciones/:id/convertir', fn($p) => self::app('cotizaciones', 'convertir', $p));
        self::post('/cotizaciones/:id/clonar',    fn($p) => self::app('cotizaciones', 'clonar',    $p));
        ...
        self::post('/ventas/:id/titulo',              fn($p) => self::app_extra('ventas', 'acciones', $p, ['accion'=>'titulo']));
        ...
        self::post('/ventas/:id/quitar-desc-int',     fn($p) => self::app_extra('ventas', 'acciones', $p, ['accion'=>'quitar-desc-int']));
        self::post('/ventas/:id/agregar-item',        fn($p) => self::app_extra('ventas', 'acciones', $p, ['accion'=>'agregar-item']));
        ...
        self::post('/config/propiedad/:id/foto',           fn($p) => self::app('config', 'propiedad_foto', $p));
        self::post('/config/propiedad/:id/foto/eliminar',  fn($p) => self::app_extra('config', 'propiedad_foto', $p, ['accion'=>'eliminar']));
