...
<div style="max-width:520px;margin:40px auto;padding:0 16px">
    ...
    <div style="text-align:center;margin-bottom:24px">
        ...
        <h2 style="font-size:22px;font-weight:800;margin:0 0 8px">Renueva tu licencia <?= $trial['plan_label'] ?></h2>
        <p style="color:var(--t2);margin:0;line-height:1.6">
            Tu licencia <?= $trial['plan_label'] ?> vence el <strong><?= date('d/m/Y', strtotime($trial['plan_vence'])) ?></strong> (<?= $trial['dias_restantes'] ?> dias restantes).
        </p>
    </div>
    ...
    <div style="text-align:center;margin-bottom:24px">
        ...
        <h2 style="font-size:22px;font-weight:800;margin:0 0 8px">Tu plan <?= $trial['plan_label'] ?></h2>
        <p style="color:var(--t2);margin:0;line-height:1.6">
    ...
    <div style="background:var(--white);border:1px solid var(--border);border-radius:var(--r);padding:24px;box-shadow:0 1px 3px rgba(0,0,0,.04)">
        <form action="/ayuda/ticket" method="POST" id="licenciaForm">
            ...
            <div style="margin-bottom:16px">
                ...
                <select id="lic-plan" name="plan_lic" style="width:100%;padding:10px 12px;border:1.5px solid var(--border2);border-radius:var(--r-sm);font:400 14px var(--body);background:var(--white);color:var(--text)">
                    ...
                    <option value="Business">Business — $2,999/mes (con demo y capacitación)</option>
                </select>
            </div>

            <div style="margin-bottom:16px">
                <label style="display:block;font-size:13px;font-weight:600;color:var(--t1);margin-bottom:6px">Duracion deseada</label>
            ...
            <button type="submit" style="width:100%;padding:12px;border:none;border-radius:var(--r-sm);font:600 14px var(--body);background:var(--g);color:#fff;cursor:pointer;transition:opacity .12s" onmouseover="this.style.opacity='.85'" onmouseout="this.style.opacity='1'" onclick="
                ...
                this.form.querySelector('[name=titulo]').value = 'Solicitud de licencia ' + plan + ' — ' + dur;
        ...
        <p style="font-size:12px;color:var(--t3);margin:14px 0 0;text-align:center;line-height:1.5">
            Seras contactado a la brevedad con la liga de cobro para activar tu licencia.
        </p>
    </div>
