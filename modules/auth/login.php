...
(function() {
    ...
    function getDeviceSig() {
        try {
            ...
            var textR = 0;
            try { var el = document.createElement('span'); el.style.cssText = 'position:absolute;visibility:hidden;font:-apple-system-body;white-space:nowrap;'; el.textContent = 'M'; document.body.appendChild(el); var th = el.offsetHeight; document.body.removeChild(el); textR = th < 18 ? 1 : th < 21 ? 2 : th < 25 ? 3 : th < 30 ? 4 : th < 36 ? 5 : 6; } catch(e) {}
