  ...
  <div class="lb">
    ...
    <div style="border-top:1px dashed var(--border);padding:2px 14px 2px 52px">
      ...
      <div style="display:none;padding:6px 0;font:400 11px var(--num);color:var(--t2);line-height:1.7">
        ...
        <div class="dbg-row"><span class="dbg-lbl">  pen bajo benchmark</span><span class="dbg-val dbg-neg"><?= ($es['eng_pen_bajo_benchmark'] ?? 0) > 0 ? '-'.round(($es['eng_pen_bajo_benchmark'] ?? 0) * 100, 1).'%' : '—' ?></span></div>
