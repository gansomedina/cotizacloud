...
<style>
/* ─── Tabs ───────────────────────────────────────────────── */
.cfg-tabs-wrap{background:var(--white);border-bottom:1px solid var(--border);position:sticky;top:54px;z-index:90;overflow-x:auto;scrollbar-width:none;margin:-16px 0 24px}
      ...
      <table class="tbl">
        ...
        <tbody>
          ...
          <tr data-cup-id="<?= (int)$cup['id'] ?>">
            ...
            <td style="font:500 13px var(--num);color:var(--t3)"><?= (int)$cup['usos'] ?></td>
            <td><span class="tbl-badge <?= $cup['activo']?'badge-on':'badge-off' ?>"><?= $cup['activo']?'Activo':'Inactivo' ?></span></td>
            <td>
              <div class="tbl-actions">
                <button class="tbl-btn"
