...
$GLOBALS['PLAYBOOK'] = [
    ...
    'probable_cierre' => [
        'priority'   => 'alta',
        'tone'       => 'warm',
        'summary'    => 'Actividad reciente y momentum. Bandeja amplia de calor comercial.',
        'psychology' => 'La cotización sigue viva en su cabeza. No necesariamente decidió, pero no se fue. Sigue en proceso interno — comparando, consultando o esperando un impulso.',
        'meaning'    => [
            'Hay interés vigente, no es un lead muerto.',
            'La cotización sigue siendo relevante para él.',
            'Mezcla de casos muy buenos y otros solo activos — no todos igual.',
        ],
        'do' => [
            'Contactar hoy o mañana máximo.',
            'Mensaje corto con una sola pregunta.',
            'Buscar que responda algo — cualquier cosa — para retomar conversación.',
        ],
        'dont' => [
            'No mandar un texto largo explicando todo de nuevo.',
            'No asumir que ya está listo para firmar.',
            'No mezclar varios beneficios en el mismo mensaje.',
        ],
        'messages' => [
            [
                'canal' => '📱 WhatsApp',
                'texto' => '[Nombre], ¿sigue en pie el proyecto o gusta modificar algo de la cotización?',
                'nota'  => 'Abre la puerta a que diga lo que sea — si quiere ajustar algo, si sigue igual, o si cambió algo. Cualquier respuesta es útil.',
            ],
            [
                'canal' => '📱 WhatsApp — si no responde en 24h',
                'texto' => '[Nombre], ¿tiene alguna duda sobre su cotización o qué le falta para iniciar?',
                'nota'  => 'Segunda oportunidad más directa. Invita a la objeción sin presionar.',
            ],
        ],
        'best_channel' => 'WhatsApp. Llamada solo si ya hay conversación previa activa.',
        'goal'         => 'Lograr que responda algo. Un sí, un no, o una duda — cualquiera sirve.',
    ],
    ...
    'multi_persona' => [
        'priority'   => 'alta',
        'tone'       => 'blue',
        'summary'    => 'Múltiples personas revisaron la cotización. La decisión es compartida.',
        'psychology' => 'Tu contacto principal probablemente ya quiere avanzar — pero hay alguien más que tiene que convencer: pareja, socio, jefe, comité. No basta con convencer a uno. Tu trabajo es darle herramientas para que él convenza al otro.',
        'meaning'    => [
            'La decisión no es individual.',
            'Tu contacto puede ser el promotor, no el decisor.',
            'Ayudarle a él a "vender" internamente acelera el proceso.',
        ],
        'do' => [
            'Ofrecerte para atender a los involucrados juntos.',
            'Darle material para que él explique y defienda internamente.',
            'Ser muy claro en lo que más se comparte: garantías, tiempos, proceso.',
        ],
        'dont' => [
            'No presionar cierre individual si el proceso es compartido.',
            'No asumir que tu contacto decide solo.',
        ...
        'best_channel' => 'WhatsApp. Si encaja, proponer llamada o reunión breve con todos los involucrados.',
        'goal'         => 'Alinear a todos los decisores, no solo al contacto principal.',
    ],
