    ...
    <?php foreach ($rt_todas as $rt_g): ?>
      ...
      <div style="display:flex;align-items:flex-start;gap:8px;padding:9px 12px;border-bottom:1px solid var(--border)">
        ...
        <div style="flex:1;min-width:0">
          ...
          <div style="font:500 11px 'Inter',sans-serif;color:var(--t3);margin-top:1px">cerró <b style="color:var(--text)"><?= (int)$rt_f['cierres7'] ?></b>/<?= (int)$rt_f['trabajo7'] ?> trab<?php if ($rt_f['desc7'] > 0): ?> · 🗑<?= (int)$rt_f['desc7'] ?><?php if ($rt_f['sincita7'] > 0): ?> <span style="color:var(--r)">(<?= (int)$rt_f['sincita7'] ?> s/cita)</span><?php endif; ?><?php endif; ?><?php if (!empty($rt_f['venc_sube'])): ?> · <span style="color:var(--a);font-weight:700">⏰▲</span><?php endif; ?><?php if (!empty($rt_f['citas_baja'])): ?> · <span style="color:var(--a);font-weight:700">📅↓</span><?php endif; ?></div>
