...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        td code { font-family: 'SF Mono', Monaco, Consolas, monospace; font-size: 13px; background: #f1efe9; padding: 1px 5px; border-radius: 3px; }
    </style>
</head>
<body>
<div class="container">
...
<h2>1. Rol de CotizaCloud y de la empresa emisora</h2>
...
<ul>
    ...
    <li><strong>Datos de clientes finales:</strong> nombre, correo, teléfono, dirección — proporcionados por la empresa o por el propio cliente al solicitar una cotización.</li>
    <li><strong>Cotizaciones, ventas y recibos:</strong> documentos creados dentro de la plataforma.</li>
    <li><strong>Datos de uso:</strong> interacciones, IP, datos del dispositivo y del navegador para operar y mejorar el servicio.</li>
...
<ul>
    ...
    <li><strong>Cancelación:</strong> solicitar la eliminación de los datos.</li>
...
<table>
    <thead>
        <tr><th>Cookie</th><th>Tipo</th><th>Duración</th><th>Propósito</th></tr>
    </thead>
    <tbody>
        <tr><td><code>cza_session</code></td><td>Esencial</td><td>14 días (30 en app móvil)</td><td>Token de autenticación del usuario de la plataforma.</td></tr>
        <tr><td><code>cz_vid</code></td><td>Funcional</td><td>2 años</td><td>Identificador anónimo del visitante para evitar contar la misma visita varias veces y distinguir al cliente del personal interno de la empresa.</td></tr>
        <tr><td><code>cz_dsig</code></td><td>Esencial</td><td>14 días</td><td>Firma del dispositivo en sesiones autenticadas (auditoría de accesos).</td></tr>
        <tr><td><code>cz_acuse_priv</code></td><td>Funcional</td><td>1 año</td><td>Recordar que el visitante ya leyó este aviso para no mostrarlo de nuevo.</td></tr>
    </tbody>
</table>
...
<ul>
    <li><strong>Meta (Facebook, Instagram):</strong> <a href="https://facebook.com/privacy/policy" target="_blank" rel="noopener">facebook.com/privacy/policy</a></li>
