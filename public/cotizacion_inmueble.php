...
/* Info pills */
.info-pills{display:flex;flex-wrap:wrap;gap:8px;margin-top:16px}
.info-pill{padding:10px 16px;background:var(--white);border:1px solid var(--bd);border-radius:10px;display:flex;flex-direction:column}
