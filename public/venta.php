...
<div class="main">
  ...
  <div class="card">
    ...
    <div style="display:grid;grid-template-columns:<?= $grid_cols ?>;gap:6px;align-items:start;padding:11px 16px;border-bottom:1px solid var(--border)">
      <div>
        ...
        <?php if ($l['descripcion']): ?><div class="item-desc"><?= nl2br(str_contains($l['descripcion'], '<') ? e_html($l['descripcion']) : e_links($l['descripcion'])) ?></div><?php endif; ?>
      </div>
      <?php if (!$ocultar_cp): ?>
  ...
  <div class="card">
    ...
    <div style="display:grid;grid-template-columns:<?= $grid_cols_ext ?>;gap:6px;align-items:start;padding:11px 16px;border-bottom:1px solid var(--border)">
      <div>
        ...
        <?php if ($le['descripcion']): ?><div class="item-desc"><?= nl2br(str_contains($le['descripcion'], '<') ? e_html($le['descripcion']) : e_links($le['descripcion'])) ?></div><?php endif; ?>
      </div>
  ...
  <div class="card">
    <div class="terminos-card"><?= nl2br(str_contains($venta['terminos'], '<') ? e_html($venta['terminos']) : e($venta['terminos'])) ?></div>
  </div>
  <?php endif; ?>
  ...
  <table class="fac-tbl">
    ...
    <tr>
      ...
      <td>
        ...
        <?php if ($l['descripcion']): ?><div class="td-desc"><?= nl2br(str_contains($l['descripcion'], '<') ? e_html($l['descripcion']) : e_links($l['descripcion'])) ?></div><?php endif; ?>
      </td>
      <?php if (!$ocultar_cp): ?>
  ...
  <table class="fac-tbl">
    ...
    <tr>
      ...
      <td>
        ...
        <?php if ($le['descripcion']): ?><div class="td-desc"><?= nl2br(str_contains($le['descripcion'], '<') ? e_html($le['descripcion']) : e_links($le['descripcion'])) ?></div><?php endif; ?>
      </td>
